        ...
        extends Dialog
{
    ...
    public LevelCompleted( @NonNull Context context, int bgImage )
    {
        super( context );
        this.bgImage = bgImage;
    }
    
    public LevelCompleted( @NonNull Context context, int themeResId, int bgImage )
    {
    ...
    protected void onCreate( Bundle savedInstanceState )
    {
        ...
        try
        {
            view_dialog = View.inflate( getContext(), R.layout.popup_level_completed_layout, null );
            ...
            if ( view_dialog != null && getWindow() != null )
            {
                ...
                view_dialog.setOnClickListener( new View.OnClickListener()
                {
                    ...
                    public void onClick( View v )
                    {
                        ...
                        text.animate().translationX( frame.getWidth() * 2 ).setDuration( 500 ).setInterpolator( new AccelerateDecelerateInterpolator() ).start();
                    }
                } );
                ...
                view_dialog.animate().setDuration( 100 ).scaleY( 1f ).withEndAction( new Runnable()
                {
                    @Override
                    public void run()
                    {
